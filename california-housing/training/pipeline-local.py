...
local.init(
    ...
    raise_on_error=True,
    pipeline_root="./_local_test"
)

@dsl.component(
    base_image="local_kfp_test:latest",
    packages_to_install=[
        "pandas==2.0.3",
        "scikit-learn==1.3.0",
        "joblib==1.3.2",
...
def train_component(
    ...
    train_data_path = os.path.join(input_data_dir, train_data_file_name)
...
def train_pipeline() -> None:
    ...
    data_op = train_component(
        input_data_dir="/data", # In component container
