...
@dsl.component(
    ...
    target_image="637423190872.dkr.ecr.eu-west-1.amazonaws.com/highwind/ef620ece-2b04-4f7e-8932-31dd3ba63e03/7a0550a8-b644-4267-b2be-85977ab21ff0:2-0-0",
    packages_to_install=[
       "tensorflow==2.15.0",
        "tf-keras==2.15.0",
        "urllib3==1.26.0  ",
...
def tensorflow_pipeline() -> dsl.Model:
    ml_op = ml_process().set_display_name("ml-process").set_memory_request('6G').set_memory_limit('6G')
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(
        tensorflow_pipeline,
        package_path="machine_translation_training_pipeline.yaml",
    )
    print("Done")